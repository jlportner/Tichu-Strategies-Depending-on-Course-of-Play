...
\hline 
1 & $\tilde{\alpha}_1$ (AAAA) & $\tilde{\alpha}_2$ (AAAD) & $\tilde{\alpha}_3$ (AADD) \\ 
\hline 
2 & $\tilde{\alpha}_2$ (ADAA) & $\tilde{\alpha}_4$ (ADAD) & $\tilde{\alpha}_5$ (DDAD) \\ 
\hline 
3 & $\tilde{\alpha}_3$ (DDAA) & $\tilde{\alpha}_5$ (ADDD) & $\tilde{\alpha}_6$ (DDDD) \\ 
\hline 
\end{tabular}%
} 
\end{table}
...
\begin{figure}[h]
    ...
    \caption{$\rho(t)$ - Probabilitydensity}
    \label{fig:8}
    \centering
