...
\begin{figure}[h]
    ...
    \label{fig:meine-grafik}
\end{figure}
Dieser Wahrscheinlichkeitswert $\hat{\rho}(t)$ wird dann Zufallsgeneriert für ein $t\in [-0.25,0.7]$. Damit lässt sich die $\eta$-Funktion definieren:
\begin{equation*}
